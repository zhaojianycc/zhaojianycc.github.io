...
python2.7 ../ref/bibconvert.py --suffix web --highlight "ZHAO Jian" --highlight "Zhao Jian" --highlight " Zhao Jian" --highlight "Jian Zhao" --input ../ref/Top.bib --input ../ref/MyPublications.bib --header publications_header.jemdoc > publications.jemdoc
